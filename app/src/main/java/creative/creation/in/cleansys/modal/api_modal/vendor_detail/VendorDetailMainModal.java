...
package creative.creation.in.cleansys.modal.api_modal.vendor_detail;
...
public class VendorDetailMainModal implements Parcelable {
    ...
    public final static Creator<VendorDetailMainModal> CREATOR = new Creator<VendorDetailMainModal>() {
